...
struct common_params {
    ...
    bool    promptprocessing_ubatchboost_spec_draft_off = false; // disable speculative draft contexts in boost runtime
    bool    promptprocessing_ubatchboost_keep           = false; // reload boost runtime again for later prompts
    bool    tokengeneration_no_warmup                   = false; // skip warmup when loading default runtime for token generation
